...
{
    public partial class SiconCrmtask
    {
        ...
        public string AppointmentLocation { get; set; } = null!;
        public string? AppointmentGuid { get; set; }
        public int AppointmentSequence { get; set; }
        public string AppointmentPreviousEmail { get; set; } = null!;
    }
}
