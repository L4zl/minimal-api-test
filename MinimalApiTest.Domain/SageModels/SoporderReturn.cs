...
namespace MinimalApiTest.Domain.SageModels
{
    ...
    {
        public SoporderReturn()
        {
            PoptoReorderSoplines = new HashSet<PoptoReorderSopline>();
            SopcancelledLines = new HashSet<SopcancelledLine>();
            ...
            SoporderProfitAnalyses = new HashSet<SoporderProfitAnalysis>();
            SoporderReturnDocumentLinkDocuments = new HashSet<SoporderReturnDocumentLink>();
            SoporderReturnDocumentLinkSources = new HashSet<SoporderReturnDocumentLink>();
        ...
        public virtual CashAcctInvoiceAddress CashAcctInvoiceAddress { get; set; } = null!;
        public virtual SopdocDelAddress SopdocDelAddress { get; set; } = null!;
        public virtual SoprepeatOrderSchedule SoprepeatOrderSchedule { get; set; } = null!;
        public virtual ICollection<PoptoReorderSopline> PoptoReorderSoplines { get; set; }
        public virtual ICollection<SopcancelledLine> SopcancelledLines { get; set; }
        ...
        public virtual ICollection<SoporderProfitAnalysis> SoporderProfitAnalyses { get; set; }
        public virtual ICollection<SoporderReturnDocumentLink> SoporderReturnDocumentLinkDocuments { get; set; }
        public virtual ICollection<SoporderReturnDocumentLink> SoporderReturnDocumentLinkSources { get; set; }
